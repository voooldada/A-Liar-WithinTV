...
async function resolveVoting() {
  ...
  try {
    ...
    if (eliminated) {
      ...
      // Show death sequence
      showDeathSequence(eliminatedPlayer, eliminatedRole, eliminated, async () => {
        console.log('🔄 Starting death notification after sequence');
        ...
        // Timings para exibição:
        // 0-5s: Reveal do role (implementado em showDeathNotification)
        // 5-7s: Se Assassino + Traidor vivo, mostra aviso do traidor
        // 7s+: Esperar antes de avanço
